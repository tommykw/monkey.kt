...
class InfixExpression(override val token: Token, val left: Expression?, val operator: String, val right: Expression?) : NodeAdapter(), ExpressionWithToken {
    override fun toString(): String {
...
class CallExpression(override val token: Token, val function: Expression?, val arguments: List<Expression?>?) : NodeAdapter(), ExpressionWithToken {
    override fun toString(): String {
